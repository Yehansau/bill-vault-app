...
const LanguageSelector = ({ text, focused, onPress }: Props) => {
  return (
    ...
    >
      <Text
        className={`text-lg ${focused ? "text-white" : "text-black"} font-bold`}
      >
        {text}
      </Text>
    </Pressable>
    ...
    <>
      {permission.granted && (
        <View className="flex-1 bg-black justify-center">
          <View className="my-16 mx-8 flex-1">
            <Link href="/(tabs)">
            ...
            <View className="items-center flex-1 mt-4">
              <View className="rounded-full h-30 w-auto bg-[#D9D9D9] flex-row overflow-hidden">
                <LanguageSelector
                  text="English"
                  focused={selected === "English"}
                  onPress={() => setSelected("English")}
                />
                <LanguageSelector
                  text="Sinhala"
                  focused={selected === "Sinhala"}
                  onPress={() => setSelected("Sinhala")}
                />
                <LanguageSelector
                  text="Tamil"
                  focused={selected === "Tamil"}
          ...
          <View className="flex-1 items-center">
            <View className="bg-[#3B1E54] rounded-full h-auto w-auto flex-row absolute bottom-16 px-10 py-2">
              ...
              <View className="flex-col items-center px-20">
                <View className="rounded-full h-16 w-16 bottom-1/2 absolute bg-[#D9D9D9] justify-center items-center">
